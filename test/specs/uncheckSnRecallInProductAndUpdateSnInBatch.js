...
describe('080_Edit product to uncheck SN is in recall and edit batch to update valid SN', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run uncheckTheSNRecallInProductAndUpdateInBatchTest');
    ...
    it('Browser - should uncheck Serial number on the batch is recalled', async () => {
        ...
        allureReporter.addStep("uncheck Serial number on the batch is recalled")
