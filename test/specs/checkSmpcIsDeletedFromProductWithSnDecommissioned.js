...
describe('Product - display ePI Flag', () => {
    ...
    it('ProductDisplayEpiFlag_5_3-Should check If SMPC is deleted from the product and the serial number on the barcode is decommissioned', async() => {
        
        allureReporter.startStep("Check If SMPC is deleted from the product and the serial number on the barcode is decommissioned")
