...
describe('Expiry date Checks ', () => {
    ...
    it('Expiry date Checks_C3.4- should create a batch and disable day selection, enable incorrect and disable expired date ', async () => {
    
        allureReporter.startStep('Create a batch and disable day selection, enable incorrect and disable expired date')
        allureReporter.addTestId('Expiry date Checks_C3.4')
        await batches.Batch();
