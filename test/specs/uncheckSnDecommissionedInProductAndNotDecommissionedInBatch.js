...
describe('086_Edit product to uncheck SN is decommissioned and edit batch to reset decommissioned SN', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run uncheckTheSnDecommissionedInProductAndNotDecommissionedInBatchTest');
    ...
    it('Browser - should uncheck Serial number is not decommissioned', async () => {
        ...
        allureReporter.addStep("uncheck Serial number is not decommissioned")
