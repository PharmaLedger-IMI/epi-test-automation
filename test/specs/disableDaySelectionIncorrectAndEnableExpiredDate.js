...
describe('Expiry date Checks ', () => {
    ...
    it('Expiry date Checks_C3.3- should create a batch and disable day selection, incorrect and enable expired date ', async () => {
    
        allureReporter.startStep('Create a batch and disable day selection, incorrect and enable expired date')
        allureReporter.addTestId('Expiry date Checks_C3.3')
        await batches.Batch();
        ...
        await data.generateExpectationFile(info.getProductId(), info.getbatchId(false), ddMMYYYY,  info.getSerialNumber(),info.getBrandName(), "","","", "" )
        await wait.setTimeoutwait(12);
        matrix.generateImage(info.getProductId(), info.getbatchId(false), ddMMYYYY, info.getSerialNumber())
        await wait.setTimeoutwait(5);
        //create batch
