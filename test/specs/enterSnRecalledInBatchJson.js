...
describe('129_Update a batch via import of Json to enter recalled serial number', () => {



    it('Browser - update a batch via import of Json ', async () => {
        allureReporter.addTestId('ImportJson_4_9')
        allureReporter.addDescription('Update a batch via import of Json to enter recalled serial number and upload modified file. View message and click on invalid field info')
        allureReporter.addStep('1. Use the standard template Json')
        allureReporter.addStep('2. Enter recalled serial number in the json')
