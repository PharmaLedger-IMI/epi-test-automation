...
describe('108_Update a product via import of Json by deleting product code & name of medicinal product', () => {
    ...
    it('Browser - update a product via import of Json ', async () => {
        ...
        allureReporter.addDescription('Update a product via import of Json by deleting product code & name of medicinal product element and upload modified file. View message and click on invalid field info')
        allureReporter.addStep('1. Use the standard template Json')
        allureReporter.addStep('2. Delete product code & name of medicinal product in the json')
