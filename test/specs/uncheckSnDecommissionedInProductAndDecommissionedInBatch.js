...
describe('085_Edit product to uncheck SN is decommissioned and edit batch to have decommissioned SN', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run unCheckTheSnDecommissionedInProductAndDecommissionedInBatchTest');
    ...
    it('Browser - should uncheck Serial number is decommissioned', async () => {
        ...
        allureReporter.addStep("Uncheck Serial number is decommissioned")
