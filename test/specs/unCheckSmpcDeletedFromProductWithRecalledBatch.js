...
describe('066_Edit product to uncheck batch recall and delete SMPC and edit batch to have batch recall', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run uncheckTheSmpcDeletedFromProductWithRecalledBatchTest');
    ...
    it('Browser - uncheck if SMPC is deleted from the product with recalled batch', async () => {
        ...
        allureReporter.addStep("Uncheck If SMPC is deleted from the product with recalled batch")
