...
describe('Product - display ePI Flag', () => {
    ...
    it('ProductDisplayEpiFlag_5_1-Should check Serial number on the batch is unknown', async() => {
        
        allureReporter.startStep("Check Serial number on the batch is unknown")
