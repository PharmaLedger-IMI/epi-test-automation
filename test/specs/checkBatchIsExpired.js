...
describe('Product - display ePI Flag', () => {
    ...
    it('Product - display ePI Flag-Should check Batch is expired', async() => {
       ...
       // search the product codes
        ...
        await data.generateExpectationFile(info.getProductId(), info.getbatchId(true), expiredDate,  info.getSerialNumber(),info.getBrandName(), info.getBatchRecall(),"","", info.getBatchRecallMsg(),info.getEpiDisplayed() )
