...
describe('118_Update a batch via import of Json by deleting product code and batch', () => {



    it('Browser - update a batch via import of Json ', async () => {
        allureReporter.addTestId('ImportJson_4_4')
        allureReporter.addDescription('Update a batch via import of Json by deleting product code and batch elemet and uploading modified file. View message and click on invalid field info')
