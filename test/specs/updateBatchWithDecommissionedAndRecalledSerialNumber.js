...
describe('050_Edit batch to update with decommissioned and recalled serial number', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run updateBatchWithDecommissionedAndRecalledSNTest');
    ...
    it('Browser - should Update the batch with only decomissioned/ recalled serial numbers ', async () => {
        ...
        allureReporter.addStep('Update the batch with only decomissioned/ recalled serial numbers')
