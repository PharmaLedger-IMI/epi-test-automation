...
describe('032_Create a batch with MonthYear as expiry date and enable day selection, disable incorrect and expired date flag', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npx kill-port 4723 && npm run enableDaySelectionAndDisableIncorrectAndExpiredDateFlagTest');
