...
describe('096_Edit Product to check batch is unknown and edit batch to have valid SN and pass valid batch in matrix', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            await utilityFunction.runAppium("checkBatchIsUnknownInProductWithValidMatrixTestRun")
        })
    ...
    it('Browser - should check batch  on the barcode is known', async () => {
        ...
        allureReporter.addStep("Check batch on the barcode is known")
