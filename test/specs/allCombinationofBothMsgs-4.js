...
describe('Batch Recall and Batch Message', () => {
    it('should  Create a batch with a batch message and batch recall and recall message', async () => {
    
        allureReporter.startStep('Create a batch with a batch message and batch recall and recall message.')
        allureReporter.addTestId('BatchRecall&Msg_4')
        // await batches.Batch();
        ...
        //await data.expectData(gtinPage.gt(), date.randomDate(), await batches.checkBatchRecall(), await batches.checkBatchMessage())
