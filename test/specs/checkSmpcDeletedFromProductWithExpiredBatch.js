...
describe('074_Edit product to check batch is expired and delete smpc. Edit batch to have expired date', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            await utilityFunction.runAppium("checkSmpcDeletedFromProductWithExpiredBatchTestRun")
        })
    ...
    it('Browser - should check If SMPC is deleted from the product and batch mentioned on barcode is expired', async () => {
        ...
        allureReporter.addStep("Check batch mentioned on barcode is expired")
        ...
        data.generateExpectationFile(utilityFunction.getProductId(), utilityFunction.getbatchId(), expiredDate, utilityFunction.getSerialNumber(), utilityFunction.getBrandName(), utilityFunction.getBatchRecall(), "", "", utilityFunction.getBatchRecallMsg(), utilityFunction.getEpiDisplayed())
