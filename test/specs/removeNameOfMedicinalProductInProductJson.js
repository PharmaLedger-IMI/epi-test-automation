...
describe('105_Update a product via import of Json by deleting name of medicinal product ', () => {
    ...
    it('Browser - update a product via import of Json ', async() => { 
        ...
        allureReporter.addDescription('Update a product via import of Json by deleting name of medicinal product elemet and uploading modified file. View message and click on invalid field info')
