...
describe('Product - display ePI Flag', () => {
    ...
    it('Product - display ePI Flag-Should uncheck Batch  on the barcode is unknown', async() => {
        
        allureReporter.startStep("uncheck Batch  on the barcode is unknown")
       ...
       // search the product codes
        ...
        matrix.generateImage(info.getProductId(), unKnownBatch, info.getCurrentRandomDate(), info.getSerialNumber())
        await wait.setTimeoutwait(8);
