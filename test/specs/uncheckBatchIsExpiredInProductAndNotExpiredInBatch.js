...
describe('076_Edit product to uncheck batch is expired and edit batch to have valid batch', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run uncheckTheBatchIsExpiredInProductAndNotExpiredInBatchTest');
    ...
    it('Browser - should check Batch is expired', async () => {
        ...
        allureReporter.addStep("Check Batch is expired")
