...
describe('051_Edit batch to update without decommissioned and recalled serial number', () => {
    ...
    if (!process.env.npm_config_browserOnly) {
        ...
        after(async () => {
            ...
            const { stdout1, stderr1 } = await exec('cd ../epi-mobileapp-test-automation && npm run updateTheBatchWithoutDecommissionedRecalledSNTest');
    ...
    it('Browser - should Update the batch to have no decomissioned/ recalled serial numbers ', async () => {
        ...
        allureReporter.addStep('Update the batch to have no decomissioned/ recalled serial numbers')
